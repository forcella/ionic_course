    ...
    Array<
      Maybe<
        { __typename?: 'Launch' } & Pick<
          Launch,
          'id' | 'mission_name' | 'launch_date_local'
        > & {
            links: Maybe<
...
export function useLaunchesPastQuery(
  ...
  return ApolloReactHooks.useQuery<
    LaunchesPastQuery,
    LaunchesPastQueryVariables
  >(LaunchesPastDocument, baseOptions)
}
...
export type LaunchesPastQueryHookResult = ReturnType<
  typeof useLaunchesPastQuery
>
export type LaunchesPastLazyQueryHookResult = ReturnType<
  typeof useLaunchesPastLazyQuery
>
