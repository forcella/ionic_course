...
export type LaunchesPastQuery = { __typename?: 'Query' } & {
	launchesPast: Maybe<
		Array<
			Maybe<
				{ __typename?: 'Launch' } & Pick<Launch, 'id' | 'mission_name' | 'launch_date_local'> & {
						links: Maybe<
							{ __typename?: 'LaunchLinks' } & Pick<LaunchLinks, 'video_link' | 'flickr_images'>
						>;
 ...
 * });
 */
export function useLaunchesPastQuery(
	baseOptions?: ApolloReactHooks.QueryHookOptions<LaunchesPastQuery, LaunchesPastQueryVariables>
) {
	return ApolloReactHooks.useQuery<LaunchesPastQuery, LaunchesPastQueryVariables>(LaunchesPastDocument, baseOptions);
}
export function useLaunchesPastLazyQuery(
	baseOptions?: ApolloReactHooks.LazyQueryHookOptions<LaunchesPastQuery, LaunchesPastQueryVariables>
) {
	return ApolloReactHooks.useLazyQuery<LaunchesPastQuery, LaunchesPastQueryVariables>(
